...
public class UserGame {
    ...
    private String objetosID;

    public UserGame(){

    }

    public UserGame(Username user, String teamName, int points, String teamID, int money, String pujasID, String alineationID, String pujasPiedras, String objetosID) {
        this.user = user;
